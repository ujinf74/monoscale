...
## 지금 (2026-09-11, `road_step_arc: true`)

### 튜닝 세트 9개

| drive | 거리 m | RPE5 | RPE10 | RPE20 | RPE40 | hop% | walk | ATE | 끝오차 |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| str_v2 | 111 | 0.161 | 0.140 | 0.106 | 0.032 | 0.20 | 0.30 | 0.0233 | 0.0126 |
| str_v3 | 111 | 0.169 | 0.148 | 0.115 | 0.033 | 0.20 | 0.56 | 0.0313 | 0.0159 |
| str_v4 | 111 | 0.166 | 0.134 | 0.094 | 0.035 | 0.21 | 0.17 | 0.0161 | 0.0053 |
| str_1.5 | 104 | 0.093 | 0.065 | 0.041 | 0.025 | 0.13 | 0.13 | 0.0116 | 0.0284 |
| str_4.0 | 111 | 0.133 | 0.088 | 0.074 | 0.054 | 0.08 | 0.11 | 0.0186 | 0.0135 |
| str_8.0 | 150 | 0.102 | 0.088 | 0.066 | 0.052 | 0.07 | 2.21 | 0.0329 | 0.0290 |
| curve_s05 | 111 | 0.128 | 0.106 | 0.079 | 0.043 | 0.12 | 0.77 | 0.0278 | 0.0423 |
| curve_s10 | 111 | 0.141 | 0.123 | 0.107 | 0.082 | 0.12 | 2.82 | 0.0420 | 0.0655 |
| curve_s20 | 111 | 0.165 | 0.130 | 0.096 | 0.061 | 0.14 | 0.99 | 0.0176 | 0.0285 |

|  | 평균 | 최악 |
| --- | ---: | ---: |
| RPE 5 m | 0.133 % | 0.169 % |
| RPE 10 m | 0.107 | 0.148 |
| RPE 20 m | 0.083 | 0.115 |
| RPE 40 m | 0.051 | 0.082 |
| hop% | 0.12 | 0.21 |
| walk | 1.08 | 2.82 |
| **ATE/거리** | **0.0224 %** | **0.0379 %** |
| **끝오차/거리** | **0.0281 %** | **0.0591 %** |
| 반복폭 | 1.05x | |
...
|  | 평균 | 최악 |
| --- | ---: | ---: |
| ATE/거리 | 0.1875 % | 0.2905 % |
| 끝오차/거리 | 0.1750 % | 0.2557 % |
| hop% | 0.85 | 1.35 |
| walk | 0.75 | 1.15 |

이전 표(`ef10fe7`, arc 꺼짐)는 0.0226 / 0.0375 와 0.1880 / 0.2915 였다. 차이는
전부 반복폭 안이다 — `road_step_arc`는 **오차로 채택한 것이 아니라 기하로 채택했고**,
회전 드라이브에서 도로 적합이 답을 내는 프레임이 4.4% 늘어난다. 근거는 설정 파일의
해당 키 주석에 있다.
